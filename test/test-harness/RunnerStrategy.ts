...
import { DeltaStorageStrategyParms } from './RunnerParams';
...
export abstract class RunnerStrategy {
  ...
  constructor(public parms: DeltaStorageStrategyParms) { }

  // Factory method moved to RunnerStrategyFactory.ts to avoid circular imports
